# Mastering Backend - Course Platform: Build Your Own Udemy

![Design preview for the Course Platform: Build Your Own Udemy](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Course%20Platform%20Build%20Your%20Own%20Udemy%20API.png)
...
The project is to build **Course Platform: Build Your Own Udemy** and get the front end working (the front end has already integrated the API).

[Click here to view more details about this project.](https://projects.masteringbackend.com/projects/course-platform-build-your-own-udemy-api)
...
Your task is to Build Your Own Udemy. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
